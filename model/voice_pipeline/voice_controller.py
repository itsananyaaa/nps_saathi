...
def process_text_query(text: str, source_lang: str, ai_pipeline_func, user_profile: dict, requires_tts: bool = False, start_time: float = None) -> dict:
    """
    ...
    try:
        ...
        engine_response = {"intent": "unknown", "response": "An error occurred while processing your request.", "sources": [], "financial_data": {}}
